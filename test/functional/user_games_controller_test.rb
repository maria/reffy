...
class UserGamesControllerTest < ActionController::TestCase
  ...
  test "should create user_game" do
    assert_difference('UserGame.count') do
      post :create, user_game: { game_id: @user_game.game_id, points: @user_game.points, user_id: @user_game.user_id }
    end
  ...
  test "should update user_game" do
    put :update, id: @user_game, user_game: { game_id: @user_game.game_id, points: @user_game.points, user_id: @user_game.user_id }
    assert_redirected_to user_game_path(assigns(:user_game))
  end
